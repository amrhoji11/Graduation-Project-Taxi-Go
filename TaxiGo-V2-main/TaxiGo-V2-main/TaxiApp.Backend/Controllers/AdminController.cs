    ...
    public class AdminController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAdminProfile()
        {
            ...
            return Ok(new
            {
                ...
                profile.PhoneNumber,
                profile.Address,
                ProfilePhotoImg = ImageUrlHelper.BuildImageUrl(Request, profile.ProfilePhotoImg)
            });
        }
        ...
        public async Task<IActionResult> GetAllDrivers()
        {
            ...
            foreach (var driver in drivers)
                driver.ProfilePhotoUrl = ImageUrlHelper.BuildImageUrl(Request, driver.ProfilePhotoUrl);
        ...
        {
            var drivers = await repository.GetApprovedDriversAsync();
        ...
        public async Task<IActionResult> GetAllPassengers()
        {
            ...
            foreach (var passenger in passengers)
                passenger.ProfilePhotoUrl = ImageUrlHelper.BuildImageUrl(Request, passenger.ProfilePhotoUrl);
        ...
        public async Task<IActionResult> GetPassengerProfile(string id)
        {
            ...
            profile.ProfileImageUrl = ImageUrlHelper.BuildImageUrl(Request, profile.ProfileImageUrl);
        ...
        // ==========================
        // 🔹 Live current trips (map/list)
        // ==========================
        [HttpGet("CurrentTrips")]
        public async Task<IActionResult> GetCurrentTrips()
        {
            var trips = await repository.GetCurrentTripsAsync();

            foreach (var trip in trips)
                trip.DriverProfilePhotoUrl = ImageUrlHelper.BuildImageUrl(Request, trip.DriverProfilePhotoUrl);
