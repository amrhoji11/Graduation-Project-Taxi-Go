...
namespace TaxiApp.Backend.Core.Interfaces
{
    public interface IAdminRepository
    {
        ...
        Task<List<DriverListItemDto>> GetActiveDriversAsync();
        Task<List<DriverListItemDto>> GetApprovedDriversAsync();
   ...
   DateTime? toDate);
    ...
    DateTime? toDate);
        ...
        Task<List<AdminCurrentTripDto>> GetCurrentTripsAsync();
    }
}
