...
namespace TaxiApp.Backend.Core.Interfaces
{
    ...
    {
        Task<(VehiclesResponseDto? Result, string? Error)> AddVehicel(AddVehicleDto dto);
        Task<List<VehiclesResponseDto>> GetAllVehiclesAsync(int pageNumber, int pageSize);
