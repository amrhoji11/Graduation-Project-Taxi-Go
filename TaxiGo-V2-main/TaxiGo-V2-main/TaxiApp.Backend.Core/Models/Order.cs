...
namespace TaxiApp.Backend.Core.Models
{
    ...
    public class Order
    {
        ...
        // وصف/اسم موقع الوصول (مثلاً: "مطار دمشق الدولي") - اختياري تماماً كـ DropoffLat/DropoffLng
        ...
        // وقت مجدول للرحلة (اختياري) - إذا كانت قيمته null فالطلب فوري،
        // وإذا تم تحديدها فالـ TripOfferBackgroundService هو من يفعّل البحث
        // عن سائق تلقائياً عند حلول هذا الوقت بدل البحث الفوري
