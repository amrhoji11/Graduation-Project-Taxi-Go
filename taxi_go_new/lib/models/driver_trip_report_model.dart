/// Mirrors `DriverTripReportDto` (`GET /Drivers/my-trips-report`) - one
/// completed trip in the driver's own report (the backend only includes
...
class DriverTripReportModel {
  ...
  factory DriverTripReportModel.fromJson(Map<String, dynamic> json) {
